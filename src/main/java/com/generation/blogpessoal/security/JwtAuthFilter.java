...
/*
 * obejtivos da classe: trazer as validações do token feitas na JwtService
...
public class JwtAuthFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try{
            ...
            // validações se existe um user name que foi extraido do token e não temos regras configuradas de autorização
